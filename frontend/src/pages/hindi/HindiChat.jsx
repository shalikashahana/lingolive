...
const SCENARIOS = [
  { 
    ...
    icon: MessageSquare, 
    promptPrefix: "[Hindi Language Tutor Mode] You are teaching Hindi to an English speaker. For every reply, provide the Hindi (Devanagari) first, followed by the English transliteration in parentheses, and then the English translation. Example format: 'नमस्ते! (Namaste!) - Hello!'. Gently correct any mistakes. User says: ",
    welcome: () => `नमस्ते! (Namaste!) - Hello! I am Gemma, your Hindi conversation coach. You can speak in English, and I will help you translate it to Hindi, or you can try speaking in Hindi!`
  },
  { 
    id: "interview", 
    label: "Job Interview Roleplay", 
    icon: Briefcase, 
    promptPrefix: "[Hindi Job Interview Tutor Mode] You are teaching formal Hindi to an English speaker. Provide the Hindi, then (transliteration), then - English translation. User says: ",
    welcome: () => `साक्षात्कार में आपका स्वागत है! (Saakshatkaar mein aapka swaagat hai!) - Welcome to the interview practice! I will act as your hiring manager. Tell me about yourself.`
  },
  { 
    id: "business", 
    label: "Business Presentation", 
    icon: Award, 
    promptPrefix: "[Hindi Business Tutor Mode] You are teaching professional Hindi to an English speaker. Provide the Hindi, then (transliteration), then - English translation. User says: ",
    welcome: () => `व्यावसायिक प्रस्तुति में आपका स्वागत है! (Vyaavasaayik prastuti mein aapka swaagat hai!) - Welcome to the Business Presentation practice! What would you like to present today?`
  },
  { 
    id: "travel", 
    label: "Travel & Dining Out", 
    icon: Compass, 
    promptPrefix: "[Hindi Travel Tutor Mode] You are teaching conversational travel Hindi to an English speaker. Provide the Hindi, then (transliteration), then - English translation. User says: ",
    welcome: () => `यात्रा अभ्यास में आपका स्वागत है! (Yaatra abhyaas mein aapka swaagat hai!) - Welcome to Travel & Dining Out practice! Imagine you're at a hotel in New Delhi. What do you say?`
  },
];

export default function HindiChat() {
  ...
  const handleSendMessage = async (e, customText = null) => {
    ...
    try {
      ...
      // Attaching the provided API Key per user request for Hindi realtime
      const API_KEY = import.meta.env.VITE_HINDI_REALTIME_API_KEY || "";
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="font-mono text-xs text-slate-400">
              Real-Time Hindi Conversation Coach • Live Voice &amp; Text
            </p>
          </div>
        </div>
      ...
      <form onSubmit={(e) => handleSendMessage(e)} className="border-t border-white/10 bg-[#0f172a]/95 p-4 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            placeholder={isListening ? "Listening... speak now..." : "Type your sentence in English or Hindi…"}
