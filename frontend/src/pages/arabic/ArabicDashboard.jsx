...
export default function ArabicDashboard() {
  ...
  const [completedPhases, setCompletedPhases] = useState(() => {
    return JSON.parse(localStorage.getItem("arabic_cat_completed_phases") || "{}");
  });
  ...
  const handleCheckpointComplete = (score, total) => {
    if (checkpointPhase) {
      ...
      localStorage.setItem("arabic_cat_completed_phases", JSON.stringify(updated));
    }
  };
  ...
  }, [searchQuery, formattedArabicSentences, activeSentenceModuleView]);
              ...
              <div className="space-y-8 pb-20 w-full max-w-4xl mx-auto">
                ...
                >
                  ...
                  <div className="relative z-10 space-y-4 text-center sm:text-left flex flex-col items-center sm:items-start">
                    ...
                    <p className="max-w-xl font-sans text-base sm:text-lg text-white/70 leading-relaxed text-center sm:text-left">
                      Master everyday Arabic sentences grouped by real-life contexts. Use the search bar to find specific phrases instantly.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="Search for sentences in Arabic, English or Tamil..."
                    className="w-full bg-white/80 backdrop-blur-md border border-[#14213D]/15 rounded-2xl py-4 pl-12 pr-4 font-sans text-base shadow-sm focus:outline-none focus:ring-2 focus:ring-[#C9A227]/50 focus:border-[#C9A227]/50 transition-all text-[#14213D] placeholder:text-[#14213D]/40 text-right"
                    dir="rtl"
                  />
                </motion.div>
                                          ...
                                          <div key={sIndex} className="group flex flex-col sm:flex-row gap-4 sm:gap-6 p-5 rounded-2xl bg-white border border-[#14213D]/10 hover:border-[#C9A227]/30 hover:shadow-md transition-all duration-300">
                                            ...
                                            <div className="flex-1 space-y-3">
                                              <div className="flex items-start justify-between gap-4 flex-row-reverse">
                                                <p className="font-sans text-2xl sm:text-3xl text-[#14213D] font-medium leading-snug break-words text-right" dir="rtl">
                                                  {sentence.arabic}
                                                </p>
                                                <button 
