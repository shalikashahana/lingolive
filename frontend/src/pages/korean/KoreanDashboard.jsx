...
export default function KoreanDashboard() {
    ...
    koreanSentencesData.modules.forEach((mod, modIndex) => {
      ...
      for (let i = 0; i < sentences.length; i += 10) {
        ...
        parts.push({
          ...
          context: mod.description || mod.category || "Basic Sentences",
  ...
  const [completedPhases, setCompletedPhases] = useState(() => {
    return JSON.parse(localStorage.getItem("korean_cat_completed_phases") || "{}");
  });
  ...
  const handleCheckpointComplete = (score, total) => {
    if (checkpointPhase) {
      ...
      localStorage.setItem("korean_cat_completed_phases", JSON.stringify(updated));
    }
  };
  ...
  }, [searchQuery, formattedKoreanSentences, activeSentenceModuleView]);
              ...
              <div className="space-y-8 pb-20 w-full max-w-4xl mx-auto">
                ...
                >
                  ...
                  <div className="relative z-10 space-y-4 text-center sm:text-left flex flex-col items-center sm:items-start">
                    ...
                    <p className="max-w-xl font-sans text-base sm:text-lg text-white/70 leading-relaxed text-center sm:text-left">
                      Master everyday Korean sentences grouped by real-life contexts. Use the search bar to find specific phrases instantly.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <input
                    ...
                    placeholder="Search for sentences in Korean, English or Tamil..."
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {koreanSentencesData.modules.map((moduleData, i) => (
                          ...
                          >
                            ...
                            {(moduleData.description || moduleData.category) && <span className="text-sm text-gray-500 mt-2 text-center">{moduleData.description || moduleData.category}</span>}
                            <div className="mt-4">
                                            ...
                                            <div key={sIndex} className="group flex flex-col sm:flex-row gap-4 sm:gap-6 p-5 rounded-2xl bg-white border border-[#14213D]/10 hover:border-[#C9A227]/30 hover:shadow-md transition-all duration-300">
                                              ...
                                              <div className="flex-1 space-y-3">
                                                <div className="flex items-start justify-between gap-4">
                                                  ...
                                                  <button 
                                                    onClick={() => playAudio(sentence.korean)}
